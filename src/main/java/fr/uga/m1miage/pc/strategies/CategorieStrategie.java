...
public enum CategorieStrategie {
    DONNANT_DONNANT,
    ...
    public static CategorieStrategie fromString(String strategyName) {
        switch (strategyName) {
            case "DonnantDonnant":
            ...
            default:
                throw new IllegalArgumentException("Mauvaise categorie de strategie : " + strategyName);
        }
    }
}